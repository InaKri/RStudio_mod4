...
>>>>>>> d20457bff76f3b92a19254b96f5f28a9c84e2b4e
```
Note the warning!!!
...
ggplot(data = mpg) + 
  ...
  facet_wrap(~ class, nrow = 2)
```
#facet_wrap is uesd for vewing all individualls categories in theri own graphs
#nrow is number of rows in a given dataframe
#ncol is number of columns is a dataframe
>>>>>>> d20457bff76f3b92a19254b96f5f28a9c84e2b4e
...
```
#Added a line to see the average. 
#removed the x from displx
>>>>>>> d20457bff76f3b92a19254b96f5f28a9c84e2b4e
...
<<<<<<< HEAD
=======
#If we use geom_line the lines is drawn from each point. The geom_smooth is drawing an average line of all points which makes it easier to understand.
>>>>>>> d20457bff76f3b92a19254b96f5f28a9c84e2b4e
...
```
#Removed the # and also the s from "mapping"
>>>>>>> d20457bff76f3b92a19254b96f5f28a9c84e2b4e
...
=======
#this function turn off the standard error / standard confidence intervals for the line.
#If se = FALSE in geom_smooth it means missing values are removed without a warning by default.
>>>>>>> d20457bff76f3b92a19254b96f5f28a9c84e2b4e
...
ggplot(data = mpg, aes(x = displ, y = hwy)) +
  geom_line()
```
# Used the geom_line to get a line chart. This looked the best out of the options
>>>>>>> d20457bff76f3b92a19254b96f5f28a9c84e2b4e
...
=======
#The two graphs looks identical cause they use the same datsett, the same points is showen on the plot and they both uses a genom_smooth to draw a line that shows the average.
>>>>>>> d20457bff76f3b92a19254b96f5f28a9c84e2b4e
...
<<<<<<< HEAD
=======
#specify the y axsis to get the right order on the different categories frequency rather than the trend.
>>>>>>> d20457bff76f3b92a19254b96f5f28a9c84e2b4e
...
<<<<<<< HEAD
=======
#Yes, the warning says Please use after_stat(prop) instead.
#Changed the code 
>>>>>>> d20457bff76f3b92a19254b96f5f28a9c84e2b4e
...
<<<<<<< HEAD
=======
#The colours is based n yellow and blue and avoid red because it helps increase readability for the visualizations.
